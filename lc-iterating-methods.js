//forEach, filter, map, reduce, some/every, sort, find
...
const isAll18 = users.some((user) => user.age > 18);
/* console.log(isAll18); */

//find
const user = users.find((user) => user.name === "Austin Benton");
/* console.log(user); */

//sort
const strArr = ["Andrei", "Jorgo", "Anton"];
strArr.sort();
const numArr = [10, 7, 41, 1, 32];
