describe("Form", () => {
  ...
  it("When typing a value into origin city autocomplete, this autocomplete is visible and has typed value", () => {
    ...
    cy.get("@autocompleteOrigin").type("Новосибирск");
    cy.get("@autocompleteOrigin").should("have.value", "Новосибирск");
  });
  ...
  it("When typing a value into destination city autocomplete, this autocomplete is visible and has typed value", () => {
    ...
    cy.get("@autocompleteDestination").type("Новокузнецк");
    cy.get("@autocompleteDestination").should("have.value", "Новокузнецк");
  });
